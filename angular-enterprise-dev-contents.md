...
### 6.6 attribute、 class 和 style 绑定
6.6.1 attribute 绑定
6.6.2 class 绑定
6.6.3 style 绑定
...
### 7.2 属性型指令
7.2.1 了解 NgClass、NgStyle
7.2.2 实例25:创建并使用属性型指令
7.2.3 实例26:购应用户引发的事件
...
### 17.3 实例72:通过ngx- translate插件实现国际化
17.3.1 添加ngx- translate库
17.3.2 导入并配置ngx- translate模块
17.3.3 注入 Translate Service服务
17.3.4 编写翻译文件
17.3.5 使用ngx- translate
17.3.6 运行应用

## 18. 编译与部署 Angular应用程序
...
### 18.2 了解 Angular模板编译器选项

### 18.3 理解 Angular元数据与AOT
18.3.1 理解元数据的限制
18.3.2 理解AOT的工作原理
...
### 20.1 了解 Service Worker

### 20.2 实例74:使用 Service Worker
...
### 20.3 了解 Service Worker 的通信机制
20.3.1 有可用更新和已激活更新
20.3.2 检查更新
20.3.3 強制激活更新
20.3.3 强制激活更新

### 20.4 配置 Service Worker
